...
urlpatterns = [
    ...
    path('initiate-bachs/<str:tracking_id>/', initiate_bachs_session, name='initiate-bachs'),
    path('webhooks/bachs/', bachs_webhook, name='bachs-webhook'),
    ...
    path('admin/ai-stage-pipeline/', ai_stage_pipeline, name='ai-stage-pipeline'),
