...
def send_transactional_email(shipment, email_type: str):
    ...
    if email_type == 'confirmation':
        ...
        main_body = f"""
            ...
            <p>To ensure this is the best way to reach you with delivery alerts, would you mind sending a quick 'OK' in reply?</p>
        ...
        heading = "Your Shipment Has Arrived"
        main_body = f"""
            <p>Hello {creator_name},</p>
